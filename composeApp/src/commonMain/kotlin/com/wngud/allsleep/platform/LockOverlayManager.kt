...
interface LockOverlayManager {
    ...
    fun showOverlay(devices: List<com.wngud.allsleep.domain.model.DeviceState> = emptyList())
    fun updateDevices(devices: List<com.wngud.allsleep.domain.model.DeviceState>)
    fun hideOverlay()
}
